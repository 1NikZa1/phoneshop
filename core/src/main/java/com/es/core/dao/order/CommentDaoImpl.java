...
public class CommentDaoImpl implements CommentDao {
    private static final String ALL_COMMENTS = "SELECT review, reviewDate, id, user FROM orders";
    private static final String COMMENT_FOR_ORDER = "SELECT review, reviewDate, user FROM orders WHERE id = ?";
